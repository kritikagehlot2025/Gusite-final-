  ...
  },
  {
    ...
    topics: [
      ...
      topic("DD Kisan — Salaam India", "Lead role on national agricultural television.",
        "Lead role in Salaam India, a programme broadcast on DD Kisan — the agricultural channel of Doordarshan, India's national public broadcaster. A full lead role, performed on a production team, shot and broadcast to a national audience.",
        { type: "youtube", src: PLAYLIST, caption: "DD Kisan · Salaam India — Lead Role" }),
      topic("Zee TV — Woh Apna Sa", "Holi special on primetime Indian television.",
        "Appeared in the Holi special episode of Woh Apna Sa on Zee TV — one of India's largest primetime entertainment channels. A high-production television appearance in a nationally broadcast seasonal special.",
      ...
      topic("Asian Paints Advertisement", "National brand, television commercial.",
        "Featured in a television advertisement for Asian Paints — one of India's largest paint manufacturers with national advertising campaigns. A production-level commercial appearance.",
        { type: "youtube", src: PLAYLIST, caption: "Asian Paints — Television Commercial" }),
      ...
      topic("Hindi Medium — Dubbing", "Voice work on an Irrfan Khan film.",
        ...
        { type: "youtube", src: PLAYLIST, caption: "Hindi Medium — Dubbing Credit" }),
