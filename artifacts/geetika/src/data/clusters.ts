...
export const CLUSTERS: Cluster[] = [
     ...
     ══════════════════════════════════════════════════════════ */
  {
    ...
    topics: [
      ...
      topic("Engineering Build Log", "Season-by-season documentation.",
      ...
      topic("WHS Jazz Band", "Grade 10 — Westmount High School jazz ensemble.",
        "Member of the Westmount High School jazz band in grade 10. Repertoire included 'Mack the Knife' and other jazz standards — guitar parts notated with chord voicings, extensions, and arrangement markings. Jazz discipline is different from classical: the rests are deliberate, the changes are fast, and the feel is everything.",
      ...
      topic("Side Quests", "Things that don't fit a category.",
        "Random projects, one-off experiments, and curiosities that didn't become obsessions but absolutely shaped the way I think.",
      ...
      topic("Ryan Princess Competition", "Crowned. The first win.",
        "Won the Ryan Princess Competition — an inter-school competition for young students. The earliest on-record win. The crown is still somewhere in the house in Rajasthan.",
        { type: "image", src: "/photo-crown.jpg", caption: "Ryan Princess Competition — Crowned" }),
      topic("Gladrags — Little Miss India", "Top 10 finalist. National pageant.",
        "Selected as a Top 10 finalist in Gladrags Little Miss & Master India — a nationally recognised children's talent and modelling pageant. A full competition cycle: auditions, callbacks, the finals lineup.",
      ...
      topic("Writing Samples", "Excerpts, essays, and experiments.",
        "Selected creative and analytical writing pieces across fiction, nonfiction, and experimental formats."),
      ...
      topic("Creative Method", "How the work happens.",
        "Workflow spanning ideation, drafting, revision, and completion across writing, music, and technical projects."),
      topic("Repertoire", "The catalog of what I perform.",
        "A living list of ragas, compositions, and pieces — primarily within the Hindustani classical tradition."),
      ...
      topic("Mixed Media", "When one material isn't enough.",
        "Artworks combining multiple materials and formats."),
      ...
      topic("Community & Family", "Roots and responsibilities.",
        "Family background and community involvement within cultural and educational contexts."),
      topic("Badminton", "Court sport, court discipline.",
        "Participation in badminton through training and competitive play."),
      topic("Table Tennis", "Reflex over reach.",
        "Experience in table tennis with emphasis on speed and reaction-based gameplay."),
      ...
      topic("Strategic Thinking", "The thread between games and life.",
        "Application of structured decision-making across academic, technical, and game-based contexts."),
      topic("Freelance Design", "Custom t-shirt design. Paid client work.",
        "Took on freelance design work for custom t-shirt projects — handling client brief, concept development, artwork creation, and final deliverable. Paid freelance work, completed independently."),
    ],
  },
