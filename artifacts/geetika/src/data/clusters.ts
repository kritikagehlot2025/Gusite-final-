  ...
  },
  {
    ...
    topics: [
      ...
      topic("Physics Journey", "From curiosity to self-directed study.",
        "Independent study in physics began during early schooling years, initially driven by curiosity in space and fundamental forces. Continued development includes mechanics, electromagnetism, quantum concepts, and introductory university-level material, alongside structured school physics. Lab visits and seminars with working physicists have deepened the practical dimension of this study.",
        { type: "image", src: "/photo-lab-microscope.jpg", caption: "Cancer Cell Lab — Zeiss Microscope, March 2025" }),
