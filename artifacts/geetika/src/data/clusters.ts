...
export const CLUSTERS: Cluster[] = [
     ...
     ══════════════════════════════════════════════════════════ */
  {
    ...
    tagline: "education, exams, awards, physics, and research interests.",
    topics: [
      /*, with embeds, */
      topic("Graduation 2026", "Sec 5, crossing the stage!",
        "Completing Sec 5 in Montréal in 2026. A huge milestone that marks the end of high school and the start of the next chapter! 5 years condensed into a lot of accumulated work!",
      ...
      topic("Narayana Co Kaveri School", "India's most rigorous secondary program. The highest batch.",
        "Enrolled in Narayana Co Kaveri, one of India's most prestigious and academically rigorous secondary school chains, known for producing top NEET and JEE performers. Placed in the highest academic batch, reserved for the strongest students in the country. The curriculum is well beyond standard secondary level, University-level science and mathematics are taught at an outstanding pace and depth that makes students more than prepared for international & national medical and engineering entrance exams, including being able to ace The IIT JEE Advanced, deemed one of the toughest entrance examinations in the world, at the young ages of 13-14",
      ...
      topic("Allen Institute, Elite Batch", "India's topmost coaching institute. The batch for the best.",
        "Enrolled in Allen Career Institute, India's premium-tier competitive exam coaching institute, known nationally for producing NEET and JEE toppers. Placed in the topmost batch, reserved exclusively for the highest-scoring and most academically advanced students.\n\nThe Allen study material. Pre-Medical Physics on May 26, 2023: vectors, resolution, dot products, and force problems at age 13",
        { type: "image", src: "/photo-allen-physics.jpg", caption: "Allen Pre-Medical Physics, May 26, 2023" }),
      topic("Advanced, University Biology at 14", "College-level biology. Self-annotated. Proof of serious study.",
        "In 2023, studying college-level advanced biology at an age when most students are still doing basic cellular structure. The Allen biology crossing paths with deep, mucosal layers, Brunner's glands, Paneth cells, nerve plexuses, Peyer's patches..\n\nThe mitochondria notes (also May 26, 2023): Kolliker discovery, C. Benda naming, Oxysomes and ATP synthase particles, Endosymbiont Hypothesis tracing to Purple Sulphur Bacteria. All of it, at 14.",
      ...
      topic("Jun Ye Seminar", "Youngest attendee in a Nobel-adjacent physics lecture.",
        "Attended a public lecture by Jun Ye, quantum physicist at JILA (Joint Institute for Laboratory Astrophysics), NIST Fellow, and University of Colorado Boulder professor. Jun Ye's work on optical lattice atomic clocks and ultracold molecules is among the most cited in modern precision physics. Was the youngest person in the room. Stayed after to speak with him and with McGill Physics Head Kenneth Ragan",
      ...
      topic("Cancer Cell Lab", "Pipettes, gel electrophoresis, and real hands-on cancer-science.",
      ...
      topic("TCS ION IntelliGem, Won", "National competition. Won twice.",
        "Competed & won in TCS ION IntelliGem, a national competition organized by Tata Consultancy Services. Won with this drawing for moral values, along with an impressive speech. Winning entry: SDG 11, Sustainable Cities and Communities, rendered in a full illustrated scene with facts, statistics, characters, and a WOW callout, all hand-drawn and annotated.\n\nWon once in person, then won again in the online edition during the 2021 lockdown. Two wins, two different formats.",
      ...
      topic("Space Dream", "Astronaut frame. Real intention.",
        "A science museum allowing people to stand in a cutout of spacesuit and look past Earth. Behind Geetika's back are years of physics self-study, research interest in orbital mechanics, and a lot of fixation and passion..,",
        { type: "image", src: "/photo-astronaut-frame.jpg", caption: "'Be An Astronaut' Installation, Science Exhibition, India 2024" }),
     ...
     ══════════════════════════════════════════════════════════ */
  {
    ...
    topics: [
      ...
      topic("Media Credits", "The full filmography.",
        ...
        [
          { type: "image", src: "/photo-gladrags-lineup.jpg", caption: "Gladrags Little Miss & Master India" },
      ...
      topic("Canvas Art", "Paintings, drawings, visual experiments.",
        "Visual artwork including painting and drawing using multiple mediums, oil, acrylic, watercolor, and mixed media. Original works include a Saraswati composition and a landscape canvas, both installed in the home mandir.",
      ...
      topic("YMCA Youth Co-op", "VP of a youth cooperative in Montréal.",
        "Vice President of the YMCA Youth Co-op in Montréal, a student-run cooperative serving NDG, Westmount, and Côte Saint-Luc. Responsibilities include running general meetings, organizing community activities (bake-offs, outings, old age home visits), coordinating the marketing, HR, and finance committees.",
      ...
      topic("Atwater Plant Internship", "Botany, fieldwork, and a team outside the lab.",
        "Summer internship at the Atwater plant site in Montréal, working alongside a team of young researchers. Field and outdoor work involving plant study and ecological survey. The SANAAQ Centre served as a base.",
      ...
      topic("Karate", "Years on the mat.",
        "Martial arts training including discipline, forms, and the philosophy of controlled power. Structured physical training that complements intellectual work. Sports Authority of India recognition.",
      ...
      /* ── Side Quests ── */
      topic("Aerobics, Wacky Tricks, Freestyle Dance and Gymnastics", "Performances",
      ...
      topic("Badminton & Table-Tennis", "Court sport, court discipline.",
        "Participation in badminton tournaments in Goregaon sports club along with competitive plays in TT"),
      topic("Chess", "Pattern observation!",
        "Competitive and training experience in chess focused on pattern recognition and strategy."),
      topic("Freelance Design", "Custom designs from t-shirts to backpacks and sneakers",
        "Took on freelance design work for custom projects, concept development, artwork creation, and finally, pays. Paid work, ongoing and completely independent."),
    ],
  },
     ...
     ══════════════════════════════════════════════════════════ */
  {
    ...
    topics: [
      ...
      topic("Recognition", "Honours, nominations, acknowledgments.",
        "Beyond certificates, community recognition, nominations, and acknowledgments that don't fit a frame but matter."),
    ],
  },
