...
export const CLUSTERS: Cluster[] = [
  {
    ...
    topics: [
      topic("Personal Profile", "The basics at a glance.", "Born in India, raised between continents, now based in Montréal. A 15-year-old multidisciplinary mind driven by curiosity across every domain — from physics to fiction, from robotics to ragas. This is the short version of a long story.", { type: "image", src: "/photo-gladrags-solo.jpg", caption: "Gladrags Little Miss & Master India" }),
      topic("Identity Timeline", "How I got here.", "A timeline of moves, milestones, and moments that shaped the way I think. From early childhood in India to navigating new cultures in Canada, each chapter added a layer to the lens I see the world through.", { type: "image", src: "/photo-rajasthani.jpg", caption: "Rajasthan — Early Childhood" }),
  ...
  },
  {
    ...
    topics: [
      ...
      topic("Awards Archive", "Every ribbon, every certificate.", "Academic competitions, olympiad placements, honor rolls, and subject awards — catalogued with context, not just titles. SOF Science Olympiad, TCS IntelliGem Finalist, Gladrags, Whizz Kidzs Abacus National Award, and more.", { type: "image", src: "/photo-sof.jpg", caption: "SOF Science Olympiad — Certificate & Medal" }),
      ...
      topic("Math Competitions", "Proofs, speed rounds, and problem sets.", "Contest math, olympiad prep, and the grind behind fast, accurate reasoning. TCS IntelliGem Finalist — every result here is the product of repetition, pattern recognition, and calm under pressure.", { type: "image", src: "/photo-intelligem-podium.jpg", caption: "TCS IntelliGem — Finalist Presentation" }),
  ...
  },
  {
    ...
    topics: [
      topic("FRC Team 7700", "Build seasons and competition robotics.", "From CAD reviews at midnight to driver-station nerves on game day — Team 7700 is where I learned to design under deadline, debug under pressure, and trust a team. Multiple build seasons, competition records, and engineering logs.", { type: "youtube", src: "https://www.youtube.com/embed/videoseries?list=PLa3Wj4jzB_6FG8GcJA41Lx2JGtABeQN5f", caption: "FRC Team 7700 — Competition Highlights" }),
      ...
      topic("Performance Portfolio", "Stage time, documented.", "Concerts, recitals, school performances, and informal sessions — every stage is a data point. The portfolio tracks growth over years of live performance.", { type: "image", src: "/photo-hulahoop.jpg", caption: "Hula Hoop Stage Performance" }),
      ...
      topic("Child Artist Archive", "Years on screen.", "Film and television credits from childhood — acting roles, voice work, and the experience of growing up on set. Zee TV, Star Parivaar, DD Kisan, Alt Balaji, Gladrags, and Ryan International. The archive includes stills, credits, and reflections on early media work.", { type: "youtube", src: "https://www.youtube.com/embed/videoseries?list=PLa3Wj4jzB_6FG8GcJA41Lx2JGtABeQN5f", caption: "Child Artist Reel — Zee TV · Star Parivaar · Alt Balaji · DD Kisan" }),
      topic("Acting Reel", "Selected scenes and performances.", "A curated reel of acting work — dramatic scenes, comedic timing, and the craft of becoming someone else on camera. Credits span television, film, and stage.", { type: "youtube", src: "https://www.youtube.com/embed/videoseries?list=PLa3Wj4jzB_6FG8GcJA41Lx2JGtABeQN5f", caption: "Acting Reel — Full Playlist" }),
      topic("Voice & Screen", "Voice acting and on-camera work.", "Voice-over credits, dubbing work, and the particular discipline of performing with just your voice. Separate from on-camera acting, this is a distinct craft with its own techniques.", { type: "image", src: "/photo-studio.jpg", caption: "Studio Recording Session" }),
      topic("Media Credits", "The full filmography.", "Every credit, every production, every role — catalogued with context. Zee TV · Star Parivaar · DD Kisan · Alt Balaji · Gladrags Little Miss India · Ryan International. From lead roles to ensemble work, the credits tell the story of a decade on screen.", { type: "image", src: "/photo-gladrags-solo.jpg", caption: "Gladrags Little Miss & Master India — Top 10" }),
      topic("Zionaxelle", "A multimedia universe, built from scratch.", "Zionaxelle is a self-designed multimedia brand — web presence, visual identity, content strategy, and production pipeline. It's the proof that I can build something from nothing and make it coherent.", { type: "youtube", src: "https://www.youtube.com/embed/videoseries?list=PLa3Wj4jzB_6FG8GcJA41Lx2JGtABeQN5f", caption: "Zionaxelle — Content & Performance Reel" }),
      ...
      topic("Cultural Integration", "Two continents, one mind.", "Navigating Indian and North American cultures isn't just about language — it's about values, expectations, and the creative tension of belonging everywhere and nowhere simultaneously.", { type: "image", src: "/photo-rajasthani.jpg", caption: "Rajasthani Classical Dress — Cultural Roots" }),
      ...
      topic("Karate", "Years on the mat.", "Martial arts training — discipline, forms, and the philosophy of controlled power. Karate is where physical discipline meets mental clarity.", { type: "image", src: "/photo-karate.jpg", caption: "Karate — Sports Authority of India Award" }),
      topic("Abacus", "Lightning arithmetic.", "Mental math training from the elementary years — abacus competitions, speed calculations, and the numerical intuition that still shapes how I approach mathematics.", { type: "image", src: "/photo-abacus.jpg", caption: "Whizz Kidzs — Abacus National Award" }),
      ...
      topic("Childhood Trophies", "The early evidence.", "From spelling bees to art contests — the trophies and certificates from the years before the dossier. Ryan Princess Competition, Gladrags Little Miss India, and more.", { type: "image", src: "/photo-crown.jpg", caption: "Ryan Princess Competition — Crowned" }),
    ],
  },
  {
