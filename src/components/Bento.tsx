  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="force-light z-[1000] max-w-3xl !bg-paper !text-ink !border-gold/60 p-0 overflow-y-auto relative crinkle film-grain dust ring-1 ring-gold/20">
          {hasImage && (
